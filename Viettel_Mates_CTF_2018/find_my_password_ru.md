# [ENGLISH WRITEUP](find_my_password.md)
...
Первым делом закинем файлик в DIE([Detect It Easy](http://ntinfo.biz)) - он нам говорит что это 32битный PE бинарь, накрытый UPX’ом.
...
enum STATUS_E
{
    ...
    VM_REG_IDX_OVERFLOW = 0x2, // индекс регистра >= 4, ВМ останавливается
...
PS: можете поздравить меня с окончанием школы, теперь я не школота :D
